...
## استوديو المحتوى (المرحلة الأولى من المنظومة)

الرابط نفسه صار صفحة رئيسية لمنظومة محتوى كاملة تعمل بمفتاح Gemini واحد:

| الوحدة | الملف | ما تنتجه |
|---|---|---|
| هوية البراند | `index.html` | الاسم، اللهجة (مصري/خليجي/فصحى)، النبرة، الألوان، الشعار — تُطبَّق على كل الوحدات |
| فيديو Doodle | `doodle.html` | سيناريو ← رسومات ← صوت ← فيديو 1080p |
| سكريبتات ريلز | `reels.html` | ٣ سيناريوهات بالثواني مع بحث الترند (Google Search grounding) |
